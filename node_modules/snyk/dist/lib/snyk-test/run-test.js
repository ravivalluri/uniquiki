...
function runTest(packageManager, root, options) {
    return __awaiter(this, void 0, void 0, function () {
        var policyLocations, hasDevDependencies, spinnerLbl, payload, filesystemPolicy, depGraph, dockerfilePackages_1, res_1, policy;
            ...
            switch (_a.label) {
                ...
                case 6:
                    ...
                    if (options.docker && options.file && options['exclude-base-image-vulns']) {
                        res_1.vulnerabilities = res_1.vulnerabilities.filter(function (vuln) { return (vuln.dockerfileInstruction); });
                    }
                    res_1.uniqueCount = countUniqueVulns(res_1.vulnerabilities);
...
function countUniqueVulns(vulns) {
    var seen = {};
    var count = vulns.reduce(function (acc, curr) {
        if (!seen[curr.id]) {
            seen[curr.id] = true;
            acc++;
        }
